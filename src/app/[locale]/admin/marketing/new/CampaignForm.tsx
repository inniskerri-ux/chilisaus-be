          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="title"
                  name="title"
                  placeholder="e.g. Weekly Hot Sauce Drop #42"
                  required
                />
                <p className="text-[10px] text-zinc-500">
                  Only visible to you in Mailchimp.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="subject"
                  name="subject"
                  placeholder="New Spicy Arrivals inside! 🌶️"
                  required
                />
                <p className="text-[10px] text-zinc-500">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="previewText"
                name="previewText"
                placeholder="The text shown next to the subject line..."
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  name="replyTo"
                  type="email"
                  defaultValue="sales@chilisaus.be"
                  required
                />
              </div>
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-3 border border-blue-100 mb-2">
              ...
              <div className="text-xs text-blue-700 leading-relaxed">
                Enter your newsletter HTML here. You can use standard Mailchimp
                tags like
                <code className="mx-1 bg-white px-1 rounded border border-blue-200">
                  *|FNAME|*
                </code>
